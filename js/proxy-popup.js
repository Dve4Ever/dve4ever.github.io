    ...
    if (!t.isInit) {
        ...
        t.fadeEnd = function() {
            ...
            var n = {
                ...
                content: {
                    message: "Welcome to Luna Proxy! Your tab is now disguised as Google Drive, Enjoy your stay!",
                    link: "Learn more",
                    href: "https://www.varonis.com/blog/what-is-a-proxy-server/",
                    target: "_blank",
                    button: "Got it!"
                },
